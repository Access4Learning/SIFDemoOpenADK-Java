...
import openadk.library.learning.LearningDTD;
...
public class TeachingGroupPublisher extends BasePublisher
{
	public TeachingGroupPublisher(String publisherID)
	{
		super(publisherID);
		setDtd(LearningDTD.TEACHINGGROUP);
	}
