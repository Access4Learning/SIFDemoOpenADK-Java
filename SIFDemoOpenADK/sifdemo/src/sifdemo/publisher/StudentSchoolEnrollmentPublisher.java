...
public class StudentSchoolEnrollmentPublisher extends BasePublisher
{
	public StudentSchoolEnrollmentPublisher(String publisherID)
	{
		super(publisherID);
		setDtd(StudentDTD.STUDENTSCHOOLENROLLMENT);
	}
