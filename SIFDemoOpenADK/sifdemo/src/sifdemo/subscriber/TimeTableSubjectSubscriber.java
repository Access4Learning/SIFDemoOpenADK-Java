...
public class TimeTableSubjectSubscriber extends BaseSubscriber
{
	public TimeTableSubjectSubscriber(String subscriberID)
	{
		super(subscriberID);
		setDtd(SchoolDTD.TIMETABLESUBJECT);
	}
	...
	{
		//query.addCondition( SchoolDTD.TIMETABLESUBJECT_ACADEMICYEAR, ComparisonOperators.LE, "2010" );
	}
